...
// .wrangler/tmp/bundle-sixYuZ/checked-fetch.js
...
app.get("/perf", async (c) => {
  const start = performance.now();
  const data = Array.from({ length: 1e3 }, (_, i) => ({ id: i, value: Math.random() }));
...
// .wrangler/tmp/bundle-sixYuZ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-sixYuZ/middleware-loader.entry.ts
